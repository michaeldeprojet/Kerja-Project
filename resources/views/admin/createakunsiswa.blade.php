                ...
                <div class="card-body">
                    <form action="{{ route('dataakunsiswa.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <input type="" class="form-control" id="nama" name="nama" readonly>
                        </div>
                        <div class="col-12 mt-3">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <input type="" class="form-control" id="nisn" name="nisn" readonly>
                        </div>
                        <div class="col-12 mt-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="" class="form-control" id="email" name="email" readonly>
                        </div>
                        <div class="col-12 mt-3">
                            <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
                            <input type="" class="form-control" id="tempat_lahir" name="tempat_lahir" readonly>
                        </div>
                        <div class="col-12 mt-3">
                            <label for="tanggal_lahir" class="form-label">tanggal Lahir</label>
                            <input type="" class="form-control" id="tanggal_lahir" name="tanggal_lahir" readonly>
                        </div>
                        <div class="col-12 mt-3">
                            <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
                            <input type="" class="form-control" id="jenis_kelamin" name="jenis_kelamin" readonly>
                        </div>

                        <div class="col-12 mt-3">
                        <label for="recipient-name" class="col-form-label">Kompetensi Keahlian</label>
                            <select class="form-control" aria-label="Default select example" name="jurusan_id" id="jurusan" readonly>
