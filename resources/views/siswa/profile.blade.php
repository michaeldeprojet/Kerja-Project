            ...
            <div class="col-4 border-right">
                ...
                <div class="col-md-5">
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6"><label class="labels">NIS</label>
                                <input type="text" class="form-control" placeholder="first name" value="{{ Auth::user()->nis }}"></div>
                            <div class="col-md-6"><label class="labels">NISN</label><input type="text" class="form-control" value="{{ Auth::user()->nisn }}"></div>
                        </div>
                        <div class="row mt-3">
