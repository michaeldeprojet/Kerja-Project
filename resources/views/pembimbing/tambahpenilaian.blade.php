    ...
    <Form action="{{ route('nilai.create') }}">
      ...
      <div class="m-4">
        <div class="mb-3 mx-3 row">
          ...
          <select class="form-control col-sm-10" style="margin-left:20px;" name="id_siswa">
          ...
          <div class="mb-3 mx-3 row">
              ...
              <div class="col-sm-10">
                <input type="name" class="form-control" name ="kelas" id="inputname">
              </div>
          </div>
          ...
          <div class="mb-3 mx-3 row">
              ...
              <div class="col-sm-10">
                <input type="name" class="form-control" name="semester" id="inputname">
              </div>
          </div>

          <div class="mb-3 mx-3 row">
            <label for="position-option">Jurusan</label>
            <select class="form-control col-sm-10"  style="margin-left:100px;" name="jurusan_id">
          ...
          <div class="mb-3 mx-3 row">
              ...
              <div class="col-sm-10">
                <input type="name" class="form-control" name="nama_industri" id="inputname">
              </div>
          </div>
          ...
          <div class="mb-3 mx-3 row">
              ...
              <div class="col-sm-10">
                <input type="name" class="form-control" name="instruktur" id="inputname">
              </div>
          </div>
